...
$(function(){
    ...
    var employeeName=editAuthorityForm.children('.employeeName');
    editAuthority.click(function(event){
        ...
        jQuery.get("../php/getModifyEmployee.php", function (returnData, status) {
            if (status == "success") {
                ...
                for (var z = 0; z < allInfo.length; z++) {
                    employeeName.append("<option value=" + allInfo[z]["EmployeeID"] + ">" + allInfo[z]["EmployeeID"] + "-" + allInfo[z]["EmployeeName"] + "</option>");
                }
            } else {
                alert("获取信息失败");
            }
